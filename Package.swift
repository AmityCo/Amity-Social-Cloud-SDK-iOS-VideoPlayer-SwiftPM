...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.1.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "f8faa0d5bdbc552419d5b9104055f3252694e96a19c5a0c64caab09e51c166fb"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
