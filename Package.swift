...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.7.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "133954bfafb44c8be58f2f5663de0dae2bc1dd05b513d14b1d455833ca13e0c7"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
