...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.6.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "25c9564247fa2fa103f22691d2138f827f9e05ce82161e0368e535eaa2be46f3"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
