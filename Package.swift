...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.27.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "116128e5c083f7ee1c7daf900a24e6829a8979ecb99c5be4649cd88ed5f7d1b7"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
