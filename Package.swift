...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/5.33.4/AmityVideoPlayerKit.xcframework.zip",
            checksum: "b51556f671b0ffaf5fc607ce337b2349f283421867be832fbabe7db31eb22207"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
