...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.4.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "6a61b979d3567895fda59d3680087db048b351fea9fe33d3896157538a4f8a82"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
