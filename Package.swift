...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.31.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "093a6e02827c6e20429b4f7f4ab4a9886a926f0eb4c810ebbfc4bd37c8e77ec5"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
