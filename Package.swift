...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.23.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "cf79fc1393dbc40a4668d9313d528ea61755516dd7def0f67a48538e398dd4e6"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
