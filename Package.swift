...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.6.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "e3397e96df074adb4970f63d680a710a9e68e25c3147bbbbd3acdb4aa3f1d951"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
