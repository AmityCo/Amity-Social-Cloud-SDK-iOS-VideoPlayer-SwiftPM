...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.17.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "be24625cfe2a0d3dab8d858745a2748b6b6b465c0c45cced74b6e6c50ec42a34"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
