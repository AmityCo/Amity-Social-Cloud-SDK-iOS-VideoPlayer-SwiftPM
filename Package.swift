...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/5.33.5/AmityVideoPlayerKit.xcframework.zip",
            checksum: "c5420be393927cbfc62f60f66a65b7ee3e6a721d9e808fbba344982cb27be07e"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
