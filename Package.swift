...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.5.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "3a6fd6dc282e073c36f90f36c9fd7da04eb69374d0339404d6e4ae3b28cc8a5e"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
