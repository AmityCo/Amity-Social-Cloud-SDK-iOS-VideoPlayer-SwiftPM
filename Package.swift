...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.9.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "ecd58bc6cff29f986fd8505461132cf1d64960a41be361f67ef942eb900e40a1"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
