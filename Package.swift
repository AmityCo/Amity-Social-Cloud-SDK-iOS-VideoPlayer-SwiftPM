...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.6.0-beta03/AmityVideoPlayerKit.xcframework.zip",
            checksum: "d6b084d64e3503c4b17ea0eb5c2f6df5357dd94d7555cdef9b2887d880291162"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
