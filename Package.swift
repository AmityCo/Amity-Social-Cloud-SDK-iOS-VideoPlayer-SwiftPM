...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.13.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "f9239b203b96dece39e6143c7fcd637c9489caa2dcef332b9fec157b93913a48"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
