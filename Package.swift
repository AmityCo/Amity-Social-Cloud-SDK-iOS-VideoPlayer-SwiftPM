...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.7.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "18ac4d3075d241d430a70acf1486f01ef28b7ce5dc6f1bd4b4a3e62ed57be77b"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
