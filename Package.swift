...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.6.0-beta04/AmityVideoPlayerKit.xcframework.zip",
            checksum: "f21d4b91ea0b5dd8daf8de527925150cfb32b9db30e2c802adfe1fcf299e47b1"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
