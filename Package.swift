...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.13.1/AmityVideoPlayerKit.xcframework.zip",
            checksum: "0abdf174404a0756cb19caa2d83830ac674c78ce02bae1c537a2c89e93ba36d1"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
