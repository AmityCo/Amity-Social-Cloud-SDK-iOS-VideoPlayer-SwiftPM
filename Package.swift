...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.19.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "c526db66cc40748fed6c2b25749769e2f87430026cf30ab9f4d47ac70d051926"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
