...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.28.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "03ecaed5458bcd46c36f782725a4cc2ea59796a05ccb4cdba54b166223166634"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
