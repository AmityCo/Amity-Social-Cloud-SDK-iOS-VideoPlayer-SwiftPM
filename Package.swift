...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.12.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "8664a5b1ccaaebb18bc76a84af81da51c830a69766c5b7c81595238183766d93"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
