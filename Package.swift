...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/5.33.3/AmityVideoPlayerKit.xcframework.zip",
            checksum: "b147384e01b96f5c48c12fb8a696d24b61a223c69fb9f8ea39812b79782ce0a1"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
