...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.5.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "4e5eb335e2bb2d60ac954424cc25876fe4e0399215094d6aa31e9579a4b10108"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
