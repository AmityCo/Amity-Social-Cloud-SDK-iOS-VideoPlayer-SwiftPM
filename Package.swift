...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/5.33.2/AmityVideoPlayerKit.xcframework.zip",
            checksum: "3ebeef43d672170f4ddb2a35d55f147593a08aa0ea523673d0f319c599c180e1"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
