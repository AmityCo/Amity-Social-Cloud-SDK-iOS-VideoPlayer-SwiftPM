...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.4.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "869febfde692fa3cb8c11d7572b5c3ba4484694657edbe5e330c3f6c6a304003"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
