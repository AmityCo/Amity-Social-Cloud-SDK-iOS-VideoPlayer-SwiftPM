...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.6.0-beta02/AmityVideoPlayerKit.xcframework.zip",
            checksum: "ded65de4de649f5e64296954c4ba9c02e65ee266a9acac2aeafc6f7f2b709b31"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
