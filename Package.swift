...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.30.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "c6d842fba81e0ab7179f60f36004a718f47170b1ae0bec74ecca5934aaf1beb7"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
