...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.16.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "29aeb80899f0e45a3de02a6cea4ca4820fa80155ff66aa4150e00d7cf90f931a"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
