...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.4.1/AmityVideoPlayerKit.xcframework.zip",
            checksum: "66ce7b00b24b6fedf2e1353a995ed0873ae9ad74da0f916618e1f514df25ebbd"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
