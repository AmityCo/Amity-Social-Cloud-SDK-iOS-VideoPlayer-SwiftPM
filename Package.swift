...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/5.33.1/AmityVideoPlayerKit.xcframework.zip",
            checksum: "0c9b8a8c8c20d972088e261deea8c12d99241255cc4aac0b1b433561edb41f40"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
