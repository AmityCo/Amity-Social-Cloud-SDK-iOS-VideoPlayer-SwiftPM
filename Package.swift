...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.14.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "f217765662ef1a5f29f66c3d0f797d9dea5207192def65470eaeb9748fa64b06"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
