...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.3.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "521e3a0edcf9d4dce128e5fab10b1455e41a0d32423d2f1fcc93f0221d8421e5"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
