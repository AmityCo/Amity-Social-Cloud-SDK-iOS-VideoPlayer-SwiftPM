...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.3.0/AmityVideoPlayerKit.xcframework.zip",
            checksum: "4b65796bfdb9bd51075cf5a3e663174f5acaca88015c1602b843cda209630612"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
