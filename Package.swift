...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://sdk.amity.co/sdk-release/ios-frameworks/6.6.0-beta06/AmityVideoPlayerKit.xcframework.zip",
            checksum: "d45d71728511d557a9263650e031292cdc17becc3272c1fe91564e37b43497b6"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
