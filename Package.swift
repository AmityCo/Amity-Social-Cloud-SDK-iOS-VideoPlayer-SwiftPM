...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-frameworks/5.29.1/AmityVideoPlayerKit.xcframework.zip",
            checksum: "210a81c0e5537faac93f60d0652ca44551cbd38e628e1b29492a6133dced4ce0"
        ),
        .binaryTarget(
            name: "MobileVLCKit",
